...
:: Link
echo Linking... %time%
"Kamek.exe" "build/kamek.o" %OBJECTS% %debug% -dynamic -externals="C:\Users\rajwi\Desktop\pulsarcode\GameSource\symbols.txt" -versions="C:\Users\rajwi\Desktop\pulsarcode\GameSource\versions.txt" -output-combined=build\Code.pul
