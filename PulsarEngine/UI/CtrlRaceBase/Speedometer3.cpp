...
u32 CtrlRaceSpeedo3::Count() {
    ...
    if(Settings::Mgr::GetSettingValue(Settings::SETTINGSTYPE_RACE, SETTINGRACE_RADIO_SOM) == RACESETTING_SOM_OG) return 0;
...
void CtrlRaceSpeedo3::Create(Page& page, u32 index, u32 count) {
    ...
    for(int i = 0; i < count; ++i) {
        ...
        char variant[0x20];
        int pos = i;
        if(i == 0 && Settings::Mgr::GetSettingValue(Settings::SETTINGSTYPE_RACE, SETTINGRACE_RADIO_SOM) == RACESETTING_SOM_RIGHT) pos = 1;
